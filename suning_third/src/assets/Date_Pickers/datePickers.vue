<template>
    <div class="date-pickers">
        <input type="text" placeholder="选择日期" @focus="trueDateBox" :value="date" readonly  style="margin-left: -90px;"/>
        <transition name="fade">
            <div class="date-box" v-if="dateBoxFlag">
                <div class="day-select" style="width: 280px;">
                    <div>
                ...
                <div class="day-screen">
                    ...
                    <div @click="selectDay" style="width: 280px;background: #fff;">
