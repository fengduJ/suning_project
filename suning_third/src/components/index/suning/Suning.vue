	...
	<div class="suningCon">
		...
		<div class="bs-example" data-example-id="condensed-table">
			<table class="table table-condensed  table-hover">
				...
				<tbody class="SNtbody">
					<tr id="trStyle" v-for="(item,index) in orderLists" @click="selectOrderNo(index)">
...
//			this.titleList = ['延保单号', '苏宁订单号', '姓名', '手机号', '车架号', '合同生效方式', '合同生效日', '合同失效日', '产品名称', '状态'];
		},
		methods:{
			...
			selectOrderNo:function(index){
				this.$store.state.selectOrderno = this.orderLists[index].orderNo;   // vuex状态管理
